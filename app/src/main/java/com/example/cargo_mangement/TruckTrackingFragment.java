...
public class TruckTrackingFragment extends Fragment implements ItemAdapter.OnItemClickListener {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        rootView = inflater.inflate(R.layout.fragment_truck_tracking, container, false);
                ...
                .addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
                    ...
                    public void onComplete(@NonNull Task<QuerySnapshot> task) {
                        if (task.isSuccessful() && !task.getResult().isEmpty()) {
                            ...
                            navigateToLockProfile(item, userId);
                        } else {
    ...
    private void navigateToLockProfile(Item item, String userId) {
